...
public interface MengdeADT<T> {
	...
	/**
	 * Legger til et objekt av klasse T til dette mengde-objektet hvis det ikke fins
	 * fra f�r
	 * 
	 ...
	 * @return returnerer en ny mende som er snittet av denne mengden (this) og
	 *         parameteren
	 */
	 ...
	 * 
	 * @param m2 er parameteren
	 * @return returnerer en ny mende som er diffrensen av denne mengden (this) og
	 *         parameteren
	 */
